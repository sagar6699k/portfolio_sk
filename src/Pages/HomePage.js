    ...
    >
      <HomePageStyled>
        ...
        <div className="typography">
          ...
          <h1 style={{fontSize:70,color:"var(--primary-color)"}} >Sagar Kurewar</h1>
          <span
            ref={info}
          ...
          <div className="icons">
            <a href="https://www.linkedin.com/in/sagar-kurewar/" className="icon i-linked"
            target="_blank"
            rel="noopener noreferrer"
            >
             <LinkedInIcon/>
            </a>
            <a href="https://github.com/sagar6699k" className="icon i-github"
            target="_blank"
            rel="noopener noreferrer"
            >
              <GithubIcon />
